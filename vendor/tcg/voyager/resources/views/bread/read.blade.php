...
@section('page_header')
    <h1 class="page-title">
        ...
        @if( $dataType->slug == "contact")
            <a href="{{ route('voyager.replyToContact', ['id' => $dataTypeContent->getKey() ]) }}" class="btn btn-sm btn-success pull-right reply">
                <i class="voyager-list"></i> <span class="hidden-xs hidden-sm">Reply</span>
            </a>
        @endif
    </h1>
